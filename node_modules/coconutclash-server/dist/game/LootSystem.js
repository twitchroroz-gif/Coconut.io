...
import { ItemType, LOOT_WEIGHTS, INITIAL_LOOT_COUNT, MAX_LOOT_ON_MAP, LOOT_RESPAWN_INTERVAL_SEC, PLAYER_PICKUP_RANGE } from "coconutclash-shared";
...
export class LootSystem {
    ...
    handlePickup(sessionId) {
        ...
        if (closestItemIndex !== -1) {
            ...
            this.applyItemEffect(player, item.itemType);
            // Remove item
            this.state.lootItems.splice(closestItemIndex, 1);
        }
    }
    applyItemEffect(player, itemType) {
        switch (itemType) {
